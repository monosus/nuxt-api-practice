        ...
        <form method="post" action="#">
          <div class="c-form-default">
            <div class="c-form-default__row">
              <FormColumn>
                <FormGroup label="苗字（漢字）" errorText="入力してください">
                  <InputText placeholder="山田" hasError />
                </FormGroup>
                <FormGroup label="名前（漢字）" errorText="入力してください">
                  <InputText placeholder="太郎" hasError />
                </FormGroup>
              </FormColumn>
            </div>
            <div class="c-form-default__row">
              <FormColumn>
                <FormGroup label="苗字（カナ）" errorText="入力してください">
                  <InputText placeholder="ヤマダ" hasError />
                </FormGroup>
                <FormGroup label="名前（カナ）" errorText="入力してください">
                  <InputText placeholder="タロウ" hasError />
                </FormGroup>
              </FormColumn>
            </div>
            <div class="c-form-default__row">
              <FormColumn size="2b">
                <FormGroup label="メールアドレス" errorText="入力してください">
                  <InputText
            ...
            <div class="c-form-default__row _mt-64">
              ...
              >
                <div class="c-list-result">
                  <div
                    v-if="building.listBuilding.length > 0"
                    class="c-list-result__list"
                  >
                    <div
                      v-for="(item, index) in building.listBuilding"
                      :key="index"
...
export default {
  setup() {
    ...
    const building = reactive({ listBuilding: [] })

    const handleDeleteResult = (index) => {
      building.listBuilding.splice(index, 1)
    }
