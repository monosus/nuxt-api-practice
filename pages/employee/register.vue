            ...
            <div class="c-form-default__row">
              <FormColumn>
                <FormGroup label="苗字（漢字）">
                  <InputText placeholder="山田" />
                </FormGroup>
                <FormGroup label="名前（漢字）">
                  <InputText placeholder="太郎" />
                </FormGroup>
              </FormColumn>
            </div>
            <div class="c-form-default__row">
              <FormColumn>
                <FormGroup label="苗字（カナ）">
                  <InputText placeholder="ヤマダ" />
                </FormGroup>
                <FormGroup label="名前（カナ）">
                  <InputText placeholder="タロウ" />
                </FormGroup>
              </FormColumn>
            </div>
            <div class="c-form-default__row">
              <FormColumn size="2b">
                <FormGroup label="メールアドレス">
                  <InputText placeholder="taro.yamada@worklifeplus.co.jp" />
                </FormGroup>
              </FormColumn>
            </div>
            <div class="c-form-default__row">
