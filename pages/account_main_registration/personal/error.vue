<template>
  <LayoutRegister>
    <TitleSubLine title="個人情報登録" sub="登録情報を入力してください。" />

    <div class="c-form-account-register -personal">
      <form method="post" action="#">
        <div class="c-form-default">
          <div class="c-form-default__row">
            <div class="c-form-column-member">
              <FormGroup label="氏（漢字）" errorText="必須項目です">
                <InputText placeholder="山田" value="" isLarge hasError />
              </FormGroup>
              <FormGroup label="名（漢字）" errorText="必須項目です">
                <InputText placeholder="太郎" value="" isLarge hasError />
              </FormGroup>
            </div>
          </div>
          ...
          <div class="c-form-default__row">
            <div class="c-form-column-member">
              <FormGroup label="氏（カナ）" errorText="必須項目です">
                <InputText placeholder="ヤマダ" value="" isLarge hasError />
              </FormGroup>
              <FormGroup label="名（カナ）" errorText="必須項目です">
                <InputText placeholder="タロウ" value="" isLarge hasError />
              </FormGroup>
            </div>
          </div>
          ...
          <div class="c-form-default__row">
            <div class="c-form-column-member -width-1b">
              <FormGroup
                ...
                isOptional
              >
                <InputText placeholder="email@exsample.com" value="" isLarge />
              </FormGroup>
            </div>
          </div>
          ...
          <div class="c-form-default__row">
            <div class="c-form-column-member -block">
              <FormGroup
                ...
                isOptional
              >
                <InputText placeholder="09012345678" value="" isLarge />
              </FormGroup>
            </div>
          </div>
          ...
          <div class="c-form-default__row">
            <div class="c-form-column-member -width-1b">
              <FormGroup
                label="その他の内容"
                suggestText="担当業務でその他と回答した方は内容を記入してください"
                errorText="エラーメッセージが入ります"
              >
                <InputText
              ...
              <FormGroup label="興味関心のある事項" isOptional>
                ...
                <div class="c-list-input -column-wide _mt-32">
                  ...
                  <InputCheckbox
                    ...
                    isLarge
                  />
                  <InputCheckbox text="選択肢A選択肢A選択肢A選択肢A" isLarge />
                  <InputCheckbox text="選択肢A選択肢A選択肢A選択肢A" isLarge />
                  <InputCheckbox text="選択肢A選択肢A選択肢A選択肢A" isLarge />
                  <InputCheckbox text="選択肢A選択肢A選択肢A選択肢A" isLarge />
                  <InputCheckbox text="選択肢A選択肢A選択肢A選択肢A" isLarge />
                  ...
                  <div class="c-list-input__box-detail">
                    ...
                    <div class="c-list-input__right">
                      <FormGroup errorText="エラーメッセージが入ります">
                        <InputText
